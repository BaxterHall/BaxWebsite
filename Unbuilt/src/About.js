                ...
                <div className='row'>
                    <div className='col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3'>
                        ...
                        <div className="about">
                            ...
                            <p className="about-me">
                                When I'm not behind my laptop screen I can be found playing guitar with <a className='warmframes' target="_blank" href="https://youtu.be/Jf8dLMdOz-M">Warm</a><a className='warmframes' target="_blank" href="https://warmframes.bandcamp.com"> Frames</a>, reading a great book, or browsing the many record stores Toronto has to offer.
                    </p>
