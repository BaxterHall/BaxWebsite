                        ...
                        <div className='journal'>
                         ...
                         <div className='movieapi'>
                            ...
                            <div className="col-sm-6 movie-text">
                                <p>I built a minimal version of the Internet Movie Database (aka IMDb), allowing users to view a list movies and click for details. You can search for Movies if you dont like the ones on the first page.</p>
                            </div>
                        </div>
                    </div>
                </div>
